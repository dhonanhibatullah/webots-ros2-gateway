...
bool wbtros2_interface__msg__wbtros2__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wbtros2_interface.msg._wbtros2.Wbtros2", full_classname_dest, 38) == 0);
  }
  wbtros2_interface__msg__Wbtros2 * ros_message = _ros_message;
  {  // topic
...
{
  /* NOTE(esteve): Call constructor of Wbtros2 */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("wbtros2_interface.msg._wbtros2");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Wbtros2");
